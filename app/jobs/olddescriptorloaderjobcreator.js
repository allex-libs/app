function createOldDescriptorLoaderJob (lib, AppJob, AppJobCore, dataSuite, Resources, environmentFactory, BasicElement, executeModifiers) {
  'use strict';
  ...
  function DescriptorLoaderJobOld (descriptorhandler, app, defer) {
    AppJob.call(this, app, defer);
    this.descriptorHandler = descriptorhandler;
  }
  lib.inherit(DescriptorLoaderJobOld, AppJob);
  DescriptorLoaderJobOld.prototype.destroy = function () {
    this.descriptorHandler = null;
    AppJob.prototype.destroy.call(this);
  };
  DescriptorLoaderJobOld.prototype._destroyableOk = function () {
  ...
  DescriptorLoaderJobOld.prototype.go = function () {
  ...
  DescriptorLoaderJobOld.prototype.handleResources = function () {
    if (!this.okToProceed()) {
      return;
    }
  ...
  DescriptorLoaderJobOld.prototype.onResourcesLoaded = function () {
    return this.loadElements();
    //this.onAllDone();
  };
  DescriptorLoaderJobOld.prototype.loadElements = function () {
    if (!this.okToProceed()) {
      return;
    }
    try {
  ...
  DescriptorLoaderJobOld.prototype.onElementsLoaded = function () {
    this.onAllDone();
  };
  ...
  DescriptorLoaderJobOld.prototype.createElement = function (desc) {
  ...
  DescriptorLoaderJobOld.prototype.addElement = function (el) {
    var id;
    if (!this.okToProceed()) {
      return;
    }
  ...
  DescriptorLoaderJobOld.prototype.produceLinks = function () {
    if (!this.okToProceed()) {
      return;
    }
    var links;
  ...
  DescriptorLoaderJobOld.prototype.produceLogic = function () {
    if (!this.okToProceed()) {
      return;
    }
    var logic;
  ...
  DescriptorLoaderJobOld.prototype.loadEnvironments = function () {
  ...
  DescriptorLoaderJobOld.prototype.createEnvironment = function (envdesc) {
  ...
  DescriptorLoaderJobOld.prototype.onAllDone = function () {
    var desc;
    if (!this.okToProceed()) {
      return;
    }
...
module.exports = createOldDescriptorLoaderJob;